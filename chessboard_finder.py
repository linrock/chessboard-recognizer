...
def _get_chessboard_gray(img, corners):
...
def get_chess_tiles_color(img, corners):
...
def get_chess_tiles_gray(img, corners):
    chessboard_img_resized = _get_chessboard_gray(img, corners)
